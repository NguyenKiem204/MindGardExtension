...
import { X, Plus, Play, Pause, ExternalLink } from "lucide-react";
        ...
        <div className="flex gap-1 px-3 pt-3">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-full transition-all ${activeTab === tab
                  ...
                  {allYoutubeMusic.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        className="group cursor-pointer flex flex-col items-center gap-2"
                        onClick={() => {
                          console.log("[Sounds] Click YouTube tile", item.id, item.name, { src: item.src, type: item.type });
                          playMusic(item);
                        }}
                      >
                        <div
